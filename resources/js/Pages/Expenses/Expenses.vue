<template>
    <page-layout page-title="Expenses">
        ...
        <template #page-body>
            <div class="flex  ">
                ...
                <card card-title="All Expenses" class="all-categories-container">
                    <template v-slot:card-header-content>
                        <router-link :to="{name:'expenses.create'}" class="btn"><i class="fas fa-plus"></i>
                            ...
                            <tr v-for="category in categories" v-if="categories" class="text-center">
                                ...
                                <td>
                                    <div class="flex  justify-end">
                                        <router-link :to="{name:'expenses.edit', params:{id:category.id}}" class="btn btn-edit">
                                            Edit
                                        </router-link>
...
export default {
    name: "Expenses",
    components: {CustomSelect, ConfirmModal, Modal, Card, PageLayout},
    setup() {
