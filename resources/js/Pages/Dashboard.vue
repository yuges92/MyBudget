<template>
    <div class="dashboard">
        ...
        <div class="page-body">
            <div class="top-row">
                <small-card amount="£19.00" card-title="Balance">
                    <template v-slot:icon>
                        <i class="fas fa-balance-scale-right" style="background: #542c2c"></i>
                    </template>
                </small-card>

                <small-card amount="£0.00" card-title="Total Savings">
                    <template v-slot:icon>
                        <i class="fas fa-piggy-bank" style="background: green"></i>
                    </template>
                </small-card>

                <small-card amount="£19.00" card-title="Total Transactions">
                    <template v-slot:icon>
                        <i class="fas fa-chart-line" style="background: #b33200"></i>
                    </template>
                </small-card>

                <small-card amount="£19.00" card-title="Total Debts">
                    <template v-slot:icon>
